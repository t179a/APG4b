...
//     diff_second の値は -86400 ~ 86400 の範囲を取とりうる
  void shift (int diff_second) {
    int sum_second = (hour * 60 * 60) + (minute * 60) + second;
    sum_second += diff_second;
    ...
    hour = sum_second / 3600;
    minute = (sum_second - (3600 * hour)) / 60;
    second = sum_second - (3600 * hour) - (60 * minute);
  }
};
